...
hexred__lt = tohex( gold(1.53) , gold(1.31) , hue_red_ )
hexgold_lt = tohex( gold(1.47) , gold(1.41) , hue_gold )
hexgren_lt = tohex( gold(1.50) , gold(1.62) , hue_gren )
hexcyan_lt = tohex( gold(1.50) , gold(1.69) , hue_cyan )
hexblue_lt = tohex( gold(1.50) , gold(1.50) , hue_blue )
