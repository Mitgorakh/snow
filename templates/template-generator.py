...
hexred__lt = tohex( lt_lum      , gold(1.25) , 030.0 )
hexgold_lt = tohex( gold(1.375) , gold(1.25) , 082.5 )
hexgren_lt = tohex( lt_lum      , gold(1.50) , 135.0 )
hexcyan_lt = tohex( lt_lum      , gold(1.50) , 195.0 )
hexblue_lt = tohex( lt_lum      , gold(1.25) , 262.5 )
hexmgnt_lt = tohex( lt_lum      , gold(1.50) , 330.0 )

hexred__dk = tohex( dk_lum      , gold(2.50) , 030.0 )
hexgold_dk = tohex( gold(0.813) , gold(2.50) , 082.5 )
hexgren_dk = tohex( dk_lum      , gold(3.00) , 135.0 )
hexcyan_dk = tohex( dk_lum      , gold(3.00) , 195.0 )
hexblue_dk = tohex( dk_lum      , gold(2.50) , 262.5 )
hexmgnt_dk = tohex( dk_lum      , gold(3.00) , 330.0 )
