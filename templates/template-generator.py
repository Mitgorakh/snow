...
hexgryc_dk = tohex( gold(0.70) , gold(4.00) , hue_base )
...
if theme_name == 'snow_redshift_plus':
  ...
  hexred__dk = tohex( gold(1.06) , cro_dk , 000.0 )
  hexgren_dk = tohex( gold(1.06) , cro_dk , 120.0 )
  hexblue_dk = tohex( gold(1.07) , cro_dk , 240.0 )
  ...
  hexred__dk = tohex( gold(1.05) , cro_dk , 045.0 )
  hexgren_dk = tohex( gold(1.06) , cro_dk , 150.0 )
  hexblue_dk = tohex( gold(1.07) , cro_dk , 270.0 )
