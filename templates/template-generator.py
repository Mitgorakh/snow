...
hexred__lt = tohex( gold(1.50) , gold(1.31) , hue_red_ )
hexgold_lt = tohex( gold(1.44) , gold(1.38) , hue_gold )
hexgren_lt = tohex( gold(1.50) , gold(1.44) , hue_gren )
hexcyan_lt = tohex( gold(1.50) , gold(1.50) , hue_cyan )
hexblue_lt = tohex( gold(1.50) , gold(1.38) , hue_blue )
hexmgnt_lt = tohex( gold(1.50) , gold(1.44) , hue_mgnt )

hexred__dk = tohex( gold(1.00) , gold(2.62) , hue_red_ )
hexgold_dk = tohex( gold(0.88) , gold(2.75) , hue_gold )
hexgren_dk = tohex( gold(1.00) , gold(2.88) , hue_gren )
hexcyan_dk = tohex( gold(1.00) , gold(3.00) , hue_cyan )
hexblue_dk = tohex( gold(1.00) , gold(2.75) , hue_blue )
hexmgnt_dk = tohex( gold(1.00) , gold(2.88) , hue_mgnt )
