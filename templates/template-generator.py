...
hexgry1_dk = tohex( gold(3.09)  , gold(4.50)  , hue_base )
...
hexred__lt = tohex( gold(1.469) , gold(1.000) , 030.0    )
...
hexblue_lt = tohex( gold(1.469) , gold(1.125) , 262.5    )
hexmgnt_lt = tohex( gold(1.469) , gold(1.125) , 330.0    )

hexred__dk = tohex( gold(0.938) , gold(2.00)  , 030.0    )
