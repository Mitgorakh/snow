...
hexgold_lt = tohex( gold(1.438) , gold(1.250) , 082.5 )
hexgren_lt = tohex( lt_lum      , gold(1.250) , 135.0 )
hexcyan_lt = tohex( lt_lum      , gold(1.250) , 195.0 )
...
hexgren_dk = tohex( dk_lum      , gold(2.50)  , 135.0 )
hexcyan_dk = tohex( dk_lum      , gold(2.50)  , 195.0 )
