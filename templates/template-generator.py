...
hexgry1_dk = tohex( gold(3.13)  , gold(4.75) , hue_base )
...
if theme_name == 'snow_redshift_plus':
  ...
  hexblue_lt = tohex( gold(1.74) , cro_lt , 210.0 )
  ...
  hexblue_lt = tohex( gold(1.77) , cro_lt , 240.0 )
  ...
  hexgren_lt = tohex( gold(1.47) , cro_lt , 135.0 )
  hexblue_lt = tohex( gold(1.75) , cro_lt , 255.0 )
  hexred__dk = tohex( gold(1.00) , cro_dk , 030.0 )
  hexgren_dk = tohex( gold(1.01) , cro_dk , 135.0 )
  hexblue_dk = tohex( gold(1.03) , cro_dk , 255.0 )
elif theme_name == 'snow_blueshift':
  hexred__lt = tohex( gold(1.41) , cro_lt , 045.0 )
  hexgren_lt = tohex( gold(1.53) , cro_lt , 150.0 )
  hexblue_lt = tohex( gold(1.64) , cro_lt , 270.0 )
  ...
  hexgren_lt = tohex( gold(1.64) , cro_lt , 180.0 )
  hexblue_lt = tohex( gold(1.49) , cro_lt , 300.0 )
