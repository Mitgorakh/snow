...
if &background ==# 'dark'
  ...
  hi Normal ctermfg=248 ctermbg=236 guifg=#a2acbd guibg=#252e39 guisp=NONE cterm=NONE gui=NONE
  ...
  hi Cursor ctermfg=254 ctermbg=236 guifg=#e1e5ed guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi IncSearch ctermfg=254 ctermbg=236 guifg=#e1e5ed guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TermCursor ctermfg=254 ctermbg=236 guifg=#e1e5ed guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi PmenuSel ctermfg=248 ctermbg=236 guifg=#a2acbd guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLineSel ctermfg=248 ctermbg=236 guifg=#a2acbd guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi WildMenu ctermfg=248 ctermbg=236 guifg=#a2acbd guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi Folded ctermfg=67 ctermbg=236 guifg=#748196 guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi StatusLineNC ctermfg=67 ctermbg=236 guifg=#748196 guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi StatusLineTermNC ctermfg=67 ctermbg=236 guifg=#748196 guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TermCursorNC ctermfg=67 ctermbg=236 guifg=#748196 guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi VertSplit ctermfg=67 ctermbg=236 guifg=#748196 guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi VisualNOS ctermfg=67 ctermbg=236 guifg=#748196 guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi Pmenu ctermfg=248 ctermbg=237 guifg=#a2acbd guibg=#2c3643 guisp=NONE cterm=NONE gui=NONE
  hi QuickFixLine ctermfg=NONE ctermbg=237 guifg=NONE guibg=#2c3643 guisp=NONE cterm=NONE gui=NONE
  hi StatusLine ctermfg=248 ctermbg=237 guifg=#a2acbd guibg=#2c3643 guisp=NONE cterm=NONE gui=NONE
  hi StatusLineTerm ctermfg=248 ctermbg=237 guifg=#a2acbd guibg=#2c3643 guisp=NONE cterm=NONE gui=NONE
  hi TabLine ctermfg=248 ctermbg=237 guifg=#a2acbd guibg=#2c3643 guisp=NONE cterm=NONE gui=NONE
  hi ToolbarButton ctermfg=248 ctermbg=237 guifg=#a2acbd guibg=#2c3643 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi PmenuSbar ctermfg=67 ctermbg=67 guifg=#748196 guibg=#748196 guisp=NONE cterm=NONE gui=NONE
  hi PmenuThumb ctermfg=248 ctermbg=248 guifg=#a2acbd guibg=#a2acbd guisp=NONE cterm=NONE gui=NONE
  ...
  hi DiffChanged ctermfg=139 ctermbg=236 guifg=#b289ab guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffText ctermfg=139 ctermbg=236 guifg=#b289ab guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TooLong ctermfg=139 ctermbg=236 guifg=#b289ab guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi WarningMsg ctermfg=139 ctermbg=236 guifg=#b289ab guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi DiffDelete ctermfg=174 ctermbg=236 guifg=#c1867f guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffRemoved ctermfg=174 ctermbg=236 guifg=#c1867f guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi Error ctermfg=174 ctermbg=236 guifg=#c1867f guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi ErrorMsg ctermfg=174 ctermbg=236 guifg=#c1867f guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi DiffAdd ctermfg=108 ctermbg=236 guifg=#7f9d77 guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffAdded ctermfg=108 ctermbg=236 guifg=#7f9d77 guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi MatchParen ctermfg=73 ctermbg=236 guifg=#5da19f guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi Visual ctermfg=67 ctermbg=236 guifg=#7c98bf guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi Search ctermfg=180 ctermbg=236 guifg=#bda77a guibg=#252e39 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  finish
endif
...
hi MoreMsg ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi NonText ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Normal ctermfg=59 ctermbg=255 guifg=#4f5d70 guibg=#eff2f5 guisp=NONE cterm=NONE gui=NONE
hi Question ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Terminal ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Title ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
hi Underlined ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE,underline gui=NONE,underline
...
hi LineNr ctermfg=67 ctermbg=NONE guifg=#748196 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi SignColumn ctermfg=67 ctermbg=NONE guifg=#748196 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Cursor ctermfg=237 ctermbg=255 guifg=#2c3643 guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi IncSearch ctermfg=237 ctermbg=255 guifg=#2c3643 guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi TermCursor ctermfg=237 ctermbg=255 guifg=#2c3643 guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi PmenuSel ctermfg=59 ctermbg=255 guifg=#4f5d70 guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi TabLineSel ctermfg=59 ctermbg=255 guifg=#4f5d70 guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi WildMenu ctermfg=59 ctermbg=255 guifg=#4f5d70 guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi Folded ctermfg=67 ctermbg=255 guifg=#748196 guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi StatusLineNC ctermfg=67 ctermbg=255 guifg=#748196 guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi StatusLineTermNC ctermfg=67 ctermbg=255 guifg=#748196 guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi TermCursorNC ctermfg=67 ctermbg=255 guifg=#748196 guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi VertSplit ctermfg=67 ctermbg=255 guifg=#748196 guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi VisualNOS ctermfg=67 ctermbg=255 guifg=#748196 guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi ColorColumn ctermfg=NONE ctermbg=254 guifg=NONE guibg=#e1e5ed guisp=NONE cterm=NONE gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=254 guifg=NONE guibg=#e1e5ed guisp=NONE cterm=NONE gui=NONE
hi CursorLine ctermfg=NONE ctermbg=254 guifg=NONE guibg=#e1e5ed guisp=NONE cterm=NONE gui=NONE
hi Pmenu ctermfg=59 ctermbg=254 guifg=#4f5d70 guibg=#e1e5ed guisp=NONE cterm=NONE gui=NONE
hi QuickFixLine ctermfg=NONE ctermbg=254 guifg=NONE guibg=#e1e5ed guisp=NONE cterm=NONE gui=NONE
hi StatusLine ctermfg=59 ctermbg=254 guifg=#4f5d70 guibg=#e1e5ed guisp=NONE cterm=NONE gui=NONE
hi StatusLineTerm ctermfg=59 ctermbg=254 guifg=#4f5d70 guibg=#e1e5ed guisp=NONE cterm=NONE gui=NONE
hi TabLine ctermfg=59 ctermbg=254 guifg=#4f5d70 guibg=#e1e5ed guisp=NONE cterm=NONE gui=NONE
hi ToolbarButton ctermfg=59 ctermbg=254 guifg=#4f5d70 guibg=#e1e5ed guisp=NONE cterm=NONE,bold gui=NONE,bold
hi PmenuSbar ctermfg=67 ctermbg=67 guifg=#748196 guibg=#748196 guisp=NONE cterm=NONE gui=NONE
hi PmenuThumb ctermfg=59 ctermbg=59 guifg=#4f5d70 guibg=#4f5d70 guisp=NONE cterm=NONE gui=NONE
hi TabLineFill ctermfg=254 ctermbg=254 guifg=#e1e5ed guibg=#e1e5ed guisp=NONE cterm=NONE gui=NONE
hi ToolbarLine ctermfg=254 ctermbg=254 guifg=#e1e5ed guibg=#e1e5ed guisp=NONE cterm=NONE gui=NONE
hi SpellBad ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=Red cterm=NONE,underline gui=NONE,undercurl
hi SpellCap ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=Blue cterm=NONE,underline gui=NONE,undercurl
hi SpellLocal ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=DarkCyan cterm=NONE,underline gui=NONE,undercurl
hi SpellRare ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=Magenta cterm=NONE,underline gui=NONE,undercurl
...
hi DiffChanged ctermfg=133 ctermbg=255 guifg=#a8559e guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffText ctermfg=133 ctermbg=255 guifg=#a8559e guibg=#eff2f5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
