...
if &background ==# 'dark'
  ...
  hi Normal ctermfg=153 ctermbg=236 guifg=#b2c0d6 guibg=#242d3b guisp=NONE cterm=NONE gui=NONE
  ...
  hi Cursor ctermfg=254 ctermbg=236 guifg=#dbe2ee guibg=#242d3b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi IncSearch ctermfg=254 ctermbg=236 guifg=#dbe2ee guibg=#242d3b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TermCursor ctermfg=254 ctermbg=236 guifg=#dbe2ee guibg=#242d3b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi FoldColumn ctermfg=153 ctermbg=NONE guifg=#b2c0d6 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi PmenuSel ctermfg=153 ctermbg=236 guifg=#b2c0d6 guibg=#242d3b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi SignColumn ctermfg=153 ctermbg=NONE guifg=#b2c0d6 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi StatusLine ctermfg=153 ctermbg=236 guifg=#b2c0d6 guibg=#242d3b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi StatusLineTerm ctermfg=153 ctermbg=236 guifg=#b2c0d6 guibg=#242d3b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TermCursorNC ctermfg=67 ctermbg=236 guifg=#748196 guibg=#242d3b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi VisualNOS ctermfg=67 ctermbg=236 guifg=#748196 guibg=#242d3b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi ColorColumn ctermfg=NONE ctermbg=237 guifg=NONE guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi CursorColumn ctermfg=NONE ctermbg=237 guifg=NONE guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi CursorLine ctermfg=NONE ctermbg=237 guifg=NONE guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi DiffChange ctermfg=NONE ctermbg=237 guifg=NONE guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi Folded ctermfg=NONE ctermbg=237 guifg=NONE guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi Pmenu ctermfg=153 ctermbg=237 guifg=#b2c0d6 guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi QuickFixLine ctermfg=NONE ctermbg=237 guifg=NONE guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi StatusLineNC ctermfg=153 ctermbg=237 guifg=#b2c0d6 guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi StatusLineTermNC ctermfg=153 ctermbg=237 guifg=#b2c0d6 guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi TabLine ctermfg=153 ctermbg=237 guifg=#b2c0d6 guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi ToolbarButton ctermfg=153 ctermbg=237 guifg=#b2c0d6 guibg=#2b3746 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi WildMenu ctermfg=153 ctermbg=237 guifg=#b2c0d6 guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi PmenuSbar ctermfg=67 ctermbg=67 guifg=#748196 guibg=#748196 guisp=NONE cterm=NONE gui=NONE
  hi PmenuThumb ctermfg=153 ctermbg=153 guifg=#b2c0d6 guibg=#b2c0d6 guisp=NONE cterm=NONE gui=NONE
  hi TabLineFill ctermfg=237 ctermbg=237 guifg=#2b3746 guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi ToolbarLine ctermfg=237 ctermbg=237 guifg=#2b3746 guibg=#2b3746 guisp=NONE cterm=NONE gui=NONE
  hi VertSplit ctermfg=67 ctermbg=67 guifg=#748196 guibg=#748196 guisp=NONE cterm=NONE gui=NONE
  ...
  hi DiffDelete ctermfg=174 ctermbg=236 guifg=#d27d75 guibg=#242d3b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffRemoved ctermfg=174 ctermbg=236 guifg=#d27d75 guibg=#242d3b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi Error ctermfg=174 ctermbg=236 guifg=#d27d75 guibg=#242d3b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi ErrorMsg ctermfg=174 ctermbg=236 guifg=#d27d75 guibg=#242d3b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi MatchParen ctermfg=73 ctermbg=237 guifg=#59a8a5 guibg=#2b3746 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi Search ctermfg=96 ctermbg=254 guifg=#95638e guibg=#dbe2ee guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  finish
endif
...
hi Question ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi NonText ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Normal ctermfg=239 ctermbg=255 guifg=#414e61 guibg=#eef2f8 guisp=NONE cterm=NONE gui=NONE
hi Terminal ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Title ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
hi Underlined ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE,underline gui=NONE,underline
hi Comment ctermfg=67 ctermbg=NONE guifg=#748196 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi CursorLineNr ctermfg=67 ctermbg=NONE guifg=#748196 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi LineNr ctermfg=67 ctermbg=NONE guifg=#748196 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Cursor ctermfg=237 ctermbg=255 guifg=#2b3746 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi IncSearch ctermfg=237 ctermbg=255 guifg=#2b3746 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi TermCursor ctermfg=237 ctermbg=255 guifg=#2b3746 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi FoldColumn ctermfg=239 ctermbg=NONE guifg=#414e61 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi PmenuSel ctermfg=239 ctermbg=255 guifg=#414e61 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi SignColumn ctermfg=239 ctermbg=NONE guifg=#414e61 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi StatusLine ctermfg=239 ctermbg=255 guifg=#414e61 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi StatusLineTerm ctermfg=239 ctermbg=255 guifg=#414e61 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
hi ColorColumn ctermfg=NONE ctermbg=254 guifg=NONE guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=254 guifg=NONE guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi CursorLine ctermfg=NONE ctermbg=254 guifg=NONE guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi DiffChange ctermfg=NONE ctermbg=254 guifg=NONE guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi Folded ctermfg=NONE ctermbg=254 guifg=NONE guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi Pmenu ctermfg=239 ctermbg=254 guifg=#414e61 guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi QuickFixLine ctermfg=NONE ctermbg=254 guifg=NONE guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi StatusLineNC ctermfg=239 ctermbg=254 guifg=#414e61 guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi StatusLineTermNC ctermfg=239 ctermbg=254 guifg=#414e61 guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi TabLine ctermfg=239 ctermbg=254 guifg=#414e61 guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi ToolbarButton ctermfg=239 ctermbg=254 guifg=#414e61 guibg=#dbe2ee guisp=NONE cterm=NONE,bold gui=NONE,bold
hi WildMenu ctermfg=239 ctermbg=254 guifg=#414e61 guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi PmenuSbar ctermfg=67 ctermbg=67 guifg=#748196 guibg=#748196 guisp=NONE cterm=NONE gui=NONE
hi PmenuThumb ctermfg=239 ctermbg=239 guifg=#414e61 guibg=#414e61 guisp=NONE cterm=NONE gui=NONE
hi TabLineFill ctermfg=254 ctermbg=254 guifg=#dbe2ee guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi ToolbarLine ctermfg=254 ctermbg=254 guifg=#dbe2ee guibg=#dbe2ee guisp=NONE cterm=NONE gui=NONE
hi VertSplit ctermfg=67 ctermbg=67 guifg=#748196 guibg=#748196 guisp=NONE cterm=NONE gui=NONE
...
hi Function ctermfg=133 ctermbg=NONE guifg=#b051a5 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Identifier ctermfg=133 ctermbg=NONE guifg=#b051a5 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi TooLong ctermfg=133 ctermbg=255 guifg=#b051a5 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi WarningMsg ctermfg=133 ctermbg=255 guifg=#b051a5 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
hi DiffDelete ctermfg=167 ctermbg=255 guifg=#c84343 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffRemoved ctermfg=167 ctermbg=255 guifg=#c84343 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi Error ctermfg=167 ctermbg=255 guifg=#c84343 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi ErrorMsg ctermfg=167 ctermbg=255 guifg=#c84343 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
hi MatchParen ctermfg=30 ctermbg=254 guifg=#008a8a guibg=#dbe2ee guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi Boolean ctermfg=32 ctermbg=NONE guifg=#007cd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Character ctermfg=32 ctermbg=NONE guifg=#007cd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Constant ctermfg=32 ctermbg=NONE guifg=#007cd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Float ctermfg=32 ctermbg=NONE guifg=#007cd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Number ctermfg=32 ctermbg=NONE guifg=#007cd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi String ctermfg=32 ctermbg=NONE guifg=#007cd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Visual ctermfg=32 ctermbg=255 guifg=#007cd2 guibg=#eef2f8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi Search ctermfg=179 ctermbg=237 guifg=#e5bc5a guibg=#2b3746 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
finish
